---
url: /docs/packages-vs-individual.md
description: >-
  Understand the difference between the Health Checker complete package and
  individual extension ZIPs. Learn which to download and when individual
  installs make sense.
---
